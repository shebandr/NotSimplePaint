...
using NotSimplePaint.Models.Shapes;
using NotSimplePaint.ViewModels;
using ReactiveUI;
using System;
...
using System.IO;
using System.Linq;
using static NotSimplePaint.Models.Shapes.PropsN;

namespace NotSimplePaint.Models {
    public class Mapper {
        public string shapeName = "Линия 1";

        public string shapeColor = "Red";
        public string shapeFillColor = "Blue";
        ...
        public Mapper(Action<object?>? upd, object? inst) {
            shapeWidth = new(250, Update, this);
            shapeHeight = new(150, Update, this);
            shapeHorizDiagonal = new(150, Update, this);
            shapeVertDiagonal = new(250, Update, this);

            shapeStartDot = new(150, 150, Update, this);
            shapeEndDot = new(250, 250, Update, this);
            shapeCenterDot = new(250, 250, Update, this);

            shapeDots = new("50,50 150,150 50,100 100,100", Update, this);

            shapeCommands = new("M 10 70 l 30,30 10,10 35,0 0,-35 m 50 0 l 0,-80 20,5 35,35 m 50 10 l 0,-50 10,0 35,35z m 70 0 l 0,30 30,0 5,-65z", Update, this);
